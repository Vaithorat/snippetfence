...
2. Do NOT remove `@fence-begin`/`@fence-end` markers without user approval
3. Read fenced regions for context only
4. If a task requires modifying a fenced region, inform the user
